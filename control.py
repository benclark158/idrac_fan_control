...
class FanMonitor:
    ...
    def print_table_row(self, temps: dict[str, int], target_speed: int, include_headings: bool = False):
        ...
        columns.append(("Fan Speed", 10, f"{target_speed}%"))
    ...
    def run(self):
        ...
        self.print_table_row(temps=self.__ipmi.get_temps(), target_speed='na', include_headings=True)
        while True:
            ...
            self.print_table_row(temps=temp, target_speed=target_fan_speed)
